      ...
      <div className="max-w-4xl mx-auto p-8">
        ...
        <section className="bg-gray-900 border-4 border-purple-400 p-6 mb-8">
          ...
          <p className="text-gray-300 mb-4">
            Liquid staking protocols that let you stake tokens and receive liquid tokens representing your staked amount.
          </p>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-3 text-gray-300">
            <li>Deposit staking tokens</li>
            <li>Receive liquid staking tokens (LST)</li>
            <li>Earn protocol rewards automatically</li>
          </ol>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-gray-700 p-6 mb-8">
          ...
          <ul className="space-y-2 text-gray-300">
            <li>✓ Multi-chain liquid staking</li>
            <li>✓ Automated reward compounding</li>
            <li>✓ LST as collateral elsewhere</li>
            <li>✓ Real-time reward tracking</li>
            <li>✓ Flexible unstaking options</li>
          </ul>
        </section>
        ...
        <section className="bg-gray-900 border-4 border-green-400 p-6 mb-8">
          ...
          <ol className="list-decimal list-inside space-y-2 text-gray-300">
            ...
            <li>Receive liquid staking tokens</li>
          </ol>
        </section>
